 ...
 * 
 * NOTE: replaced all "$" with "jQuery", by wildfire
*/
		  
var tb_pathToImage = "http://home.xingxinghuo.com/public/images/loadingAnimation.gif";
...
function tb_show(caption, url, imageGroup) {//function called when the user clicks on a thickbox link
	...
	try {
	   ...
	   var urlString = /\.jpg$|\.jpeg$|\.png$|\.gif$|\.bmp$|image/; //add image for wildfire
	   var urlType = baseURL.toLowerCase().match(urlString);
	   //alert(urlType);
		if(urlType == '.jpg' || urlType == '.jpeg' || urlType == '.png' || urlType == '.gif' || urlType == '.bmp'
			|| urlType == 'image'){//code to show images
