...
( function($) {
    ...
    _oExt.oPagination = {
        two_button : {
            ...
            fnUpdate : function(oSettings, fnCallbackDraw) {
                ...
                oSettings.nPrevious.className = (oSettings._iDisplayStart === 0) ? oSettings.oClasses.sPagePrevDisabled
                        : oSettings.oClasses.sPagePrevEnabled;
                oSettings.nNext.className = (oSettings.fnDisplayEnd() == oSettings
    ...
    $.fn.dataTable = function(oInit) {
        ...
        this.fnUpdate = function(mData, iRow, iColumn, bRedraw) {
            ...
            if (typeof mData != "object") {
                ...
                if (mData.length != oSettings.aoColumns.length) {
                    alert("Warning: An array passed to fnUpdate must have the same number of columns as the table in question - in this case "
        ...
        this.fnSetColumnVis = function(iCol, bShow) {
            ...
            if (bShow) {
                ...
                if (iInsert >= _fnVisbleColumns(oSettings)) {
                    ...
                    for (i = 0, iLen = oSettings.aoData.length; i < iLen; i++) {
                        nTd = oSettings.aoData[i]._anHidden[iCol];
                        oSettings.aoData[i].nTr.insertBefore(nTd,
                                oSettings.aoData[i].nTr
                                        .getElementsByTagName("td")[iBefore])
                    }
                }
        ...
        function _fnInitalise(oSettings) {
            ...
            _fnSortingClasses(oSettings, true);
            ...
            for ( var i = 0; i < aData.length; i++) {
                ...
                if (oSettings.aoColumns[i]._bAutoType
                    ...
                    if (oSettings.aoColumns[i].sType === null) {
                        ...
                        if (oSettings.aoColumns[i].sType == "date"
        ...
        function _fnGatherData(oSettings) {
            ...
            for (i = 0; i < oSettings.aoColumns.length; i++) {
                ...
                if (bAutoType || bRender || bClass || !bVisible) {
                    ...
                    for (j = 0; j < iLoop; j++) {
                        var nCellNode = oSettings.aoData[j].nTr
                ...
                for (i = 0, iLen = oSettings.aoColumns.length; i < iLen; i++) {
                    ...
                    if (oSettings.aoColumns[i].bVisible) {
                        if (oSettings.aoColumns[i].sWidth !== null 
                        		&& oSettings.aoColumns[i].sWidth > 0) {
                ...
                if (oSettings.fnRecordsDisplay() === 0
                    ...
                    if (oSettings.fnRecordsDisplay() === 0) {
                        ...
                        if (oSettings.fnRecordsDisplay() == oSettings
                                .fnRecordsTotal()) {
                            oSettings.anFeatures.i.innerHTML = oSettings.oLanguage.sInfo
                                    .replace("_START_",
                            ...
                            oSettings.anFeatures.i.innerHTML = oSettings.oLanguage.sInfo
                                    ...
                                    .replace("_TOTAL_",
                                            oSettings.fnRecordsDisplay())
                                    + " "
                                    + oSettings.oLanguage.sInfoFiltered
                                            .replace("_MAX_", oSettings
                                                    .fnRecordsTotal())
                                    + oSettings.oLanguage.sInfoPostFix
                        }
                    }
        ...
        function _fnFeatureHtmlFilter(oSettings) {
            ...
            nFilter.innerHTML = oSettings.oLanguage.sSearch + sSpace
                    + '<input id="search_text" type="text" />' + sSpace
                    + '<span id="search_button" class="fg-button ui-state-default ui-corner-all" href="#" style="cursor:pointer;">查询</span>';
        ...
        function _fnFeatureHtmlPaginate(oSettings) {
            ...
            oSettings.anFeatures.p = nPaginate;
        ...
        function _fnFeatureHtmlLength(oSettings) {
            ...
            $("select", nLength)
                    .change(
                            function(e) {
                                oSettings._iDisplayLength = parseInt($(this)
                                        .val(), 10);
                                _fnCalculateEnd(oSettings);
        ...
        function _fnProcessingDisplay(oSettings, bShow) {
            if (oSettings.oFeatures.bProcessing) {
                oSettings.anFeatures.r.style.visibility = bShow ? "visible"
                        : "hidden"
            }
        }
                ...
                if (!window.runtime) {
                    ...
                    for (i = 0; i < aaSort.length - 1; i++) {
                        ...
                        sDynamicSort += "iTest = oSort['" + iDataType + "-"
                                ...
                                + iDataSort + "], aoData[b]._aData["
                                + iDataSort + "] ); if ( iTest === 0 )"
                    }
                ...
                .each( function() {
                    ...
                    if (typeof oInit.asStripClasses == "undefined") {
                        oSettings.asStripClasses
                                .push(oSettings.oClasses.sStripOdd);
                        oSettings.asStripClasses
